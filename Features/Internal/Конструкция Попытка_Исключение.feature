...
Сценарий: тест
	Попытка
		И Я подключаю клиент тестирования "ИмяПрофиля1" из таблицы клиентов тестирования
	Исключение 
	...
	Попытка
		И Я подключаю клиент тестирования "ИмяПрофиля2" из таблицы клиентов тестирования
	Исключение 
