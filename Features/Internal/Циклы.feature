...
Сценарий: изменение количества во всех строках таблицы
	И для каждой строки таблицы "ItemList" я выполняю используя колонку "N"
		И в таблице "ItemList" в поле "Количество" я ввожу текст "50,00"
...
Сценарий: изменения вида цен по условиям
	И для каждой строки таблицы "ItemList" я выполняю
		Если таблица "ItemList" содержит строки Тогда:
			...
			| 'Товар с характеристиками' | 'XS/Черный'      | 'Цена поставщика 2' |
...
Сценарий: создание большоего объема данных (справочник Ед. измерения)
